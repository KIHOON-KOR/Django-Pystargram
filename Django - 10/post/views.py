...
from post.form import PostForm, PostImageFormSet, CommentForm
...
class PostCreateView(LoginRequiredMixin, CreateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        data['formset'] = PostImageFormSet # post/form.py
        return data
...
class PostUpdateView(LoginRequiredMixin, UpdateView):
    ...
    def get_context_data(self, **kwargs):
        data = super().get_context_data(**kwargs)
        data['formset'] = PostImageFormSet(instance=self.object) # post/form.py
        return data
